  ...
  async createQuoteVersion(originalQuoteId: number): Promise<Quote> {
    return await db.transaction(async (tx) => {
      ...
      const newQuoteData: InsertQuote = {
        ...
        jobsiteStreetAddress: originalQuote.jobsiteStreetAddress,
        jobsiteAddressLine2: originalQuote.jobsiteAddressLine2,
        jobsiteCity: originalQuote.jobsiteCity,
        jobsiteState: originalQuote.jobsiteState,
        jobsiteZipCode: originalQuote.jobsiteZipCode,
        jobsiteCountry: originalQuote.jobsiteCountry,
        jobsitePlaceId: originalQuote.jobsitePlaceId,
