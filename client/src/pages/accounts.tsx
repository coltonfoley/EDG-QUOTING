...
import { Plus, Building2, Briefcase, Search, Trash2 } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Manage your clients and business relationships</p>
          </div>
          <Button 
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-foreground" data-testid="text-total-clients">{totalAccounts}</p>
                </div>
              </div>
            </CardContent>
          </Card>
